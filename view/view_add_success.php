...
<body>
    ...
    <div id="center-form" class="col-6">
        <br>
    <h1 class="text-center">Success Added</h1><br>
    <h4 class="text-center"><?php echo "".$_SESSION['name']."";?></h4>
    <br> 
    <h6 class="text-center" id="text-sm">คุณได้ทำการเพิ่มคอร์สเป็นที่เรียบร้อยเเล้ว <i class="bi bi-check-circle-fill text-success"></i></h6>
